...
<div class="container">
<div class="center-align"><h1 class="product-title">Pantalones</h1></div>
</div>

<br><br>
<div class="row catalogue">
        <div class="col s12 m4 l3 marg">
        <div class="card">
            <div class="card-image waves-effect waves-block waves-light">
            <img src="../angeldemonio1.jpg" class="responsive-img activator" alt="">
            </div>
            <div class="card-content">
            <span class="card-title activator grey-text text-darken-4">Jean Example<label class="right">Ver mas</label></span>
            <p>$3600</p>
        ...
        <div class="card">
            <div class="card-image waves-effect waves-block waves-light">
            <img src="../angeldemonio2.jpg" class="responsive-img activator" alt="">
            </div>
            <div class="card-content">
            <span class="card-title activator grey-text text-darken-4">Jean Example<label class="right">Ver mas</label></span>
            <p>$3600</p>
        ...
        <div class="card">
            <div class="card-image waves-effect waves-block waves-light">
            <img src="../angeldemonio3.jpg" class="responsive-img activator" alt="">
            </div>
            <div class="card-content">
            <span class="card-title activator grey-text text-darken-4">Jean Example<label class="right">Ver mas</label></span>
            <p>$3600</p>
        ...
        <div class="card">
            <div class="card-image waves-effect waves-block waves-light">
            <img src="../angeldemonio4.jpg" class="responsive-img activator" alt="">
            </div>
            <div class="card-content">
            <span class="card-title activator grey-text text-darken-4">Jean Example<label class="right">Ver mas</label></span>
            <p>$3600</p>
